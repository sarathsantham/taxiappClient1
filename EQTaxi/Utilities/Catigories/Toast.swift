...
class Toast: UILabel {
    ...
    private let BACKGROUND_COLOR = UIColor.black.withAlphaComponent(1.0).cgColor
    ...
    public func show(_ parent: UIViewController) {
        frame = CGRect(x: SIDE_MARGIN, y: UIScreen.main.bounds.height - BOTTOM_MARGIN - 70, width: UIScreen.main.bounds.width - 2 * SIDE_MARGIN, height: HEIGHT)
